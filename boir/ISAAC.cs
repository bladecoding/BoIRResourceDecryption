//Copied from BouncyCastle.Crypto
//2 modifications.
//Fixed intToByteLittle was using big endian instead of little.
//Fixed the double call to isaac(). Previously isaac would be called after key set and on first iteration.
